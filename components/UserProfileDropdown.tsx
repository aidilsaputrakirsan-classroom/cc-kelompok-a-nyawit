  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center gap-2 md:gap-3 p-1.5 md:p-2 rounded-lg transition-colors hover:bg-gray-100 min-h-[44px]">
          ...
          <div className="text-left hidden sm:block">
            <p className="text-sm font-medium" style={{ color: '#111827' }}>John Doe</p>
            <p className="text-xs" style={{ color: '#6B7280' }}>Engineer</p>
          </div>
        </button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem className="cursor-pointer" style={{ color: '#EF4444' }}>
